...
print("Number of Playlist", noSampleClusters)
print("Playlist from bare input:", clusteredPlaylist)
print("Play List:\n")
for i in range(len(s)):
	print("Playlist",i,":",s[i])
print("\nTime Taken to make and extrapolate playlist:",time.time() - t1)